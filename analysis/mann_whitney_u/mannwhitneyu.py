...
output_file = os.path.join(output_dir, "new2_corrected_p_values_matrix.csv")
...
csv_file = os.path.join(output_dir, "new2_connections.csv")
...
print(f"Significant connections saved to /outputs/new2_connections.csv")