...
output_path = os.path.join(studydir, "code", "NENAH-BIDS", "analysis", "NBS", "results", "fs-thomas_whole_brain_connectome", "2-5_fs-thomas_thalamus_lobes_2_significant_connections.txt")
