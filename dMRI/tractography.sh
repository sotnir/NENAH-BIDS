...
Options:
  -csd				CSD mif.gz-file in anatomical space (default: derivatives/dMRI/sub-sID/dwi/csd/csd-dhollander_wm_norm_space-anat.mif.gz)
  -5TT				5TT mif.gz-file in anatomical space (default: derivatives/dMRI/sub-sID/dwi/5tt/5tt_space-anat.mif.gz)
